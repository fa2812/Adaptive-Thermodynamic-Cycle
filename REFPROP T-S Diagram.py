# -*- coding: utf-8 -*-
"""
Created on Sat Oct 16 16:16:57 2021
...
r22 = RP.REFPROPdll(fluid,"TQ","S",MASS_BASE_SI, 0,0,T_evap,0, comp)
S_22 = r22.Output[0]
...
r44 = RP.REFPROPdll(fluid,"TQ","S",MASS_BASE_SI, 0,0,T_cond,1, comp)
S_44 = r44.Output[0]
...
T_states = [T_cond, T_2, T_evap, T_evap, T_4, T_cond, T_cond]
